...
class PromptTokenStats:
    ...
    def update_from_output(
        ...
        # Clamp num_cached_tokens to <= prompt_len. A V3-restored request
        # is admitted on the surviving engine with num_computed_tokens set
        # to the host checkpoint coverage, which may include output tokens
        # generated by the original engine and therefore exceed prompt_len.
        # Without clamping, the delta below goes negative and the
